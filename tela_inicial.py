...
def janelaEntrar(janela, value, tipoConta, cpf, nConta, nome, saldo, senha):
    ...
    btnSacar = Button(janela2, text="Sacar", command=partial(
        tela_sacar.janelaSacar, janela, nConta))
    btnSacar.place(x=100, y=100)

    btnDepositar = Button(janela2, text="Depositar", command=partial(
        tela_depositar.janelaDepositar, janela, nConta))
    btnDepositar.place(x=50, y=150)

    btnExtrato = Button(janela2, text="Extrato", command=partial(
